...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($nome) || empty($email)) {
        ...
        if ($check_result->num_rows > 0) {
            ...
            $update_fields[] = "complemento = ?";
            $update_fields[] = "bairro = ?";
...
<head>
    <meta charset="utf-8">
    <title>Meu Perfil - EShopper</title>
                            ...
                            <?php if (isset($_SESSION['user_id'])): ?>
                                <div class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu rounded-0 m-0">
                                        <a href="profile.php" class="dropdown-item active">Meu Perfil</a>
            ...
            <div class="col-lg-8">
                <div class="card border-secondary mb-5">
                    <div class="card-header bg-secondary border-0">
                        <h4 class="font-weight-semi-bold m-0">Meu Perfil</h4>
                    </div>
                    <div class="card-body">
                        <?php if ($error): ?>
                        ...
                        <form action="profile.php" method="POST">
                            <div class="row">
                                ...
                                <div class="col-md-6 form-group">
                                    ...
                                    <input class="form-control telefone" type="text" name="telefone" value="<?php echo htmlspecialchars($user['telefone']); ?>">
                                </div>
                                <div class="col-md-6 form-group">
                                    <label>CEP</label>
                                    <input class="form-control cep" type="text" name="cep" value="<?php echo htmlspecialchars($user['cep']); ?>">
                                </div>
                                <div class="col-md-6 form-group">
                                    <label>Endereço</label>
                                    <input class="form-control" type="text" name="endereco" value="<?php echo htmlspecialchars($user['endereco']); ?>">
                                </div>
                                <div class="col-md-6 form-group">
                                    <label>Número</label>
                                    <input class="form-control" type="text" name="numero" value="<?php echo htmlspecialchars($user['numero']); ?>">
                                </div>
                                <div class="col-md-6 form-group">
                                ...
                                <div class="col-md-6 form-group">
                                    <label>Bairro</label>
                                    <input class="form-control" type="text" name="bairro" value="<?php echo htmlspecialchars($user['bairro']); ?>">
                                </div>
                                <div class="col-md-6 form-group">
                                    <label>Cidade</label>
                                    <input class="form-control" type="text" name="cidade" value="<?php echo htmlspecialchars($user['cidade']); ?>">
                                </div>
                                <div class="col-md-6 form-group">
                                    <label>Estado</label>
                                    <select class="form-control" name="estado">
                                        ...
                                        foreach ($estados as $sigla => $nome) {
                                            $selected = ($user['estado'] === $sigla) ? 'selected' : '';
                            ...
                            <div class="row">
                                <div class="col-md-4 form-group">
                                    ...
                                    <input class="form-control" type="password" name="senha_atual">
                                </div>
                                <div class="col-md-4 form-group">
